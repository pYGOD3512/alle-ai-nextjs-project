  ...
  return (
    <div className="container">
      ...
      <p className="dark:text-muted-foreground leading-relaxed">
        At alle-ai, we believe in the power of synergy, allowing you to
        select two AI models to unlock a truly dynamic and personalized
        experience. By combining different models, we not only offer greater
        flexibility but also enhance your creative potential. Here’s why this
        approach stands out:
      </p>
