...
import "prismjs/themes/prism-tomorrow.css"; // Dark theme for better code highlighting
import "prismjs/components/prism-python"; // Add Python syntax highlighting
import "prismjs/components/prism-bash"; // Add Bash syntax highlighting
