            ...
            <>
              <div className="flex gap-2 px-2">
                <Button
                  ...
                  variant="outline"
                  className={`flex-1 ${getSectionStyles(currentType).bgColor} ${
                    getSectionStyles(currentType).iconColor
                  }`}
                >
                  <Plus
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className={`${getSectionStyles(currentType).bgColor} ${
                    getSectionStyles(currentType).iconColor
                  }`}
                  ...
                  return (
                    <Link
                      ...
                      className={`w-full flex items-center justify-start h-8 text-sm rounded-md px-2 
                        ${
                          isActive
                            ? `${styles.bgColor} ${styles.iconColor}`
                            : ""
                        }
                        ${styles.hoverBg}`}
                    >
            ...
            <div className="space-y-2">
              <div className="space-y-2 mb-8">
                <Button
                  ...
                  variant="outline"
                  className={`flex-1 ${getSectionStyles(currentType).bgColor} ${
                    getSectionStyles(currentType).hoverBg
                  }`}
                >
                  <CurrentIcon
                    className={`h-4 w-4 ${
              ...
              {sidebarMenuItems.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <item.icon
                      className={`h-4 w-4 ${isActive ? styles.iconColor : ""}`}
                    />
                  </Link>
                );
              })}
        ...
        {isOpen ? (
          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-md m-2 cursor-pointer hover:bg-background transition-all duration-200">
            <Button
              size="sm"
              variant="outline"
              className="w-full text-xs text-white border-none bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600"
            >
              <Gem className="h-4 w-4" />
            </Button>
          </div>
