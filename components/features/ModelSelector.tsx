    ...
    <div className="grid grid-cols-auto-fit gap-2 w-full mx-auto">
      {models.map((model) => {
        ...
        return (
          ...
          >
            <p className="hidden md:flex text-xs text-left text-muted-foreground line-clamp-2 mb-auto whitespace-normal leading-[1.2rem] min-h-[2.4rem] items-center">
              {filteredResponse ? filteredResponse.substring(0, 60) + '...' : 'No preview available'}
            </p>
