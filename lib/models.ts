...
export const models: ModelDetails[] = [
  {
    ...
    provider: "OpenAI",
    description:
      "GPT-4o is a variant of GPT-4 optimized for enhanced performance in specific tasks, providing better reasoning, problem-solving, and context handling.",
    ...
    useCases: [
      {
        ...
        description:
          "Generate high-quality, long-form content, articles, stories, and creative writing with improved coherence over longer texts.",
      },
      {
        title: "Programming Assistance",
        description:
          "Offer advanced code generation, debugging, and comprehensive technical documentation support.",
      },
      {
        title: "Multimodal Applications",
        description:
          "Leverage both text and image inputs for generating detailed creative content, such as generating images based on descriptions and vice versa.",
      },
      {
        title: "Educational Support",
        description:
          "Provide tailored tutoring and problem-solving support across a wide range of subjects, including complex reasoning and detailed explanations.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Google",
    description:
      "Gemini 1.5 Pro is a state-of-the-art AI model from Google, designed for advanced natural language processing, multimodal tasks, and high-precision performance in complex problem solving.",
    ...
    useCases: [
      {
        title: "Content Creation",
        description:
          "Generate highly coherent, long-form content across various domains, including articles, blogs, and creative fiction, with improved detail and narrative structure.",
      },
      {
        title: "Multimodal Applications",
        description:
          "Create images from text and text from images, facilitating seamless integration of visual and textual content for creative and professional use.",
      },
      {
        title: "Complex Problem Solving",
        description:
          "Solve intricate and domain-specific problems, including advanced math, logic puzzles, and detailed reasoning tasks across multiple fields.",
      },
      {
        title: "Programming Assistance",
        description:
          "Assist with advanced coding tasks, including code generation, bug fixing, optimization, and producing detailed technical documentation.",
      },
      {
        title: "Personalized Tutoring",
        description:
          "Offer tailored educational support, including solving complex academic problems and providing detailed explanations on a wide range of subjects.",
      },
      {
        title: "Customer Service",
        description:
          "Power chatbots and virtual assistants for providing efficient and personalized customer support.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Anthropic",
    description:
      "Claude 3.5 Sonnet, an advanced AI language model optimized for creative writing and natural language processing, featuring improved sentiment analysis and poetry generation.",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Sophisticated text generation for various literary and creative purposes",
      },
      {
  ...
  },
  {
    ...
    description:
      "Sonar Large 32k Online is a powerful language model optimized for long-context processing, capable of handling large token windows for advanced reasoning, conversation, and complex data analysis in real-time.",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2024",
      architecture:
        "Transformer-based with specialized long-context and dynamic learning optimization",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate coherent, high-quality long-form text for articles, reports, and research papers, with a focus on maintaining context over extended content lengths.",
      },
      {
        title: "Advanced Data Analysis",
        description:
          "Analyze large datasets, perform complex calculations, and generate insights from structured or unstructured data across various domains.",
      },
      {
        title: "Multimodal Applications",
        description:
          "Combine text and image inputs for creative tasks, including generating visual content based on textual descriptions and vice versa.",
      },
      {
        title: "Real-Time Query Processing",
        description:
          "Support real-time question answering, providing instant responses to complex queries and personalized recommendations.",
      },
      {
        title: "Enterprise Integration",
        description:
          "Provide customizable solutions for businesses, including API integration, automation of workflows, and tailored enterprise knowledge bases.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "OpenAI",
    description:
      "GPT-4o Mini is a compact, lightweight variant of GPT-4o designed for faster performance with optimized efficiency for smaller tasks while maintaining high-level reasoning and natural language capabilities.",
    image: "/models/gpt-4o.png",
    type: "chat",
    version: "4o-mini",
    ...
    useCases: [
      {
        ...
        description:
          "Generate concise content for social media, short-form articles, and quick writing tasks while maintaining clarity and coherence.",
      },
      {
        title: "Code Assistance",
        description:
          "Provide fast, efficient code generation, debugging, and assistance with smaller programming tasks and quick technical queries.",
      },
      {
        title: "Real-Time Question Answering",
        description:
          "Offer quick responses to user queries, providing answers to a wide range of topics with reduced latency.",
      },
      {
        title: "Basic Image Processing",
        description:
          "Perform simple image-related tasks, such as basic description generation or interpreting images based on textual input.",
      },
      {
        title: "Personalized Assistance",
        description:
          "Provide focused, personalized support in various areas, including education, scheduling, and light business applications.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    description:
      "Gemini 1.0 Pro is Google's most advanced model, featuring highly efficient multimodal understanding and powerful reasoning capabilities for both text and visual data.",
    image: "/models/gemini.png",
    type: "chat",
    version: "1.0",
    ...
    useCases: [
      {
        ...
        description:
          "Integrated analysis of text and images for a wide range of applications",
      },
      {
        title: "Real-time Data Insights",
        description:
          "Extracting real-time insights from ongoing or live data streams",
      },
      {
        title: "Creative & Technical Content",
        description:
          "Supporting both artistic and engineering project development",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Anthropic",
    description:
      "Claude 3 Opus is an advanced version of Claude focused on safe and interpretable AI, designed for ethical AI interactions and complex reasoning tasks.",
    image: "/models/claude-3.png",
    type: "chat",
    version: "3.0 Opus",
    ...
    useCases: [
      {
        ...
        description:
          "Designed to engage with humans in ethical, transparent, and responsible ways.",
      },
      {
        title: "Complex Problem Solving",
        description:
          "Capable of solving intricate problems in various fields, especially where ethical considerations are important.",
      },
      {
        title: "Programming Assistance",
        description:
          "Providing help with debugging, code generation, and technical documentation.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Anthropic",
    description:
      "Claude 3 Sonnet is an advanced AI language model from Anthropic, designed for high-performance conversational AI, with an emphasis on ethical reasoning, creative content generation, and human-like interactions in diverse contexts.",
    image: "/models/claude-3.png",
    type: "chat",
    version: "3 Sonnet",
    releaseDate: "2024-06-20",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2024",
      architecture:
        "Transformer-based with alignment-focused safety and transparency",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate high-quality, creative writing, including poetry, stories, scripts, and artistic content, with a focus on maintaining stylistic consistency and emotional depth.",
      },
      {
        title: "Conversational AI",
        description:
          "Offer sophisticated conversational interactions, simulating human-like dialogue with ethical grounding and empathy.",
      },
      {
        title: "Problem Solving and Analysis",
        description:
          "Provide detailed explanations, logical reasoning, and solutions to complex problems, particularly in academic, technical, and philosophical domains.",
      },
      {
        title: "Ethical Decision Making",
        description:
          "Assist in making ethically sound decisions by considering diverse perspectives and potential impacts, useful in both business and personal contexts.",
      },
      {
        title: "Content Moderation and Safety",
        description:
          "Provide content filtering and moderation tools to ensure safe, inclusive, and non-harmful outputs, helping manage digital spaces responsibly.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Anthropic",
    description:
      "Claude 3 Hiaku is a variant of Claude 3, specifically optimized for creative writing, such as poetry and short-form narratives.",
    image: "/models/claude-3.png",
    type: "chat",
    version: "3.0 Hiaku",
    releaseDate: "2024",
    ...
    useCases: [
      {
        title: "Poetry Creation",
        description:
          "Specialized in generating poetry and other forms of short, creative writing.",
      },
      {
        title: "Short-form Storytelling",
        description:
          "Generating compelling short stories and other forms of brief creative writing.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Perplexity AI",
    description:
      "Sonar Small 32k Online is a compact and efficient AI model optimized for real-time performance, offering a 32k token context window and a focus on faster, less resource-intensive tasks while maintaining high accuracy and flexibility.",
    image: "/models/perplexity-ai.png",
    type: "chat",
    ...
    useCases: [
      {
        ...
        description:
          "Provide real-time, low-latency interaction with users, answering queries and offering conversational engagement with quick response times.",
      },
      {
        title: "Basic Multimodal Applications",
        description:
          "Support simple multimodal tasks such as generating brief descriptions from images or processing text and image input together.",
      },
      {
        title: "Short-Form Content Generation",
        description:
          "Generate concise, focused content for articles, emails, summaries, and reports, maintaining quality despite the smaller-scale model.",
      },
      {
        title: "Educational Support",
        description:
          "Assist in providing quick educational support, such as answering questions or providing short, digestible explanations for complex topics.",
      },
      {
        title: "Data Insights and Analysis",
        description:
          "Perform data analysis on moderate-sized datasets, extracting insights, summarizing reports, and answering data-driven questions in real-time.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "OpenAI",
    description:
      "The most advanced language model from OpenAI, featuring enhanced reasoning and broader knowledge.",
  ...
  },
  {
    ...
    provider: "OpenAI",
    description:
      "A powerful language model capable of understanding and generating human-like text across a wide range of topics and tasks.",
  ...
  },
  {
    ...
    provider: "Meta",
    description:
      "Llama 3 70B Instruct is an instruction-tuned model designed for high accuracy in specific task-oriented NLP, with a large scale for complex applications.",
    ...
    useCases: [
      {
        ...
        description: "Performing specific tasks based on detailed instructions",
      },
      {
        title: "Technical Problem Solving",
        description:
          "Providing solutions for specialized and technical challenges",
      },
      {
        title: "Task Automation",
        description: "Optimizing workflows and automating repetitive tasks",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Mistral AI",
    description:
      "Mistral 7B Instruct is a highly efficient, instruction-based model designed for precise natural language understanding and task execution with a compact architecture.",
    ...
    useCases: [
      {
        ...
        description: "Handling specific tasks with minimal resources",
      },
      {
        title: "Real-Time Chat Applications",
        description:
          "Providing low-latency responses in interactive applications",
      },
      {
        title: "Simple Query Resolution",
        description:
          "Answering direct questions or following brief instructions",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Perplexity AI",
    description:
      "Perplexity AI is a large-scale language model designed to answer questions by searching the web in real time.",
    image: "/models/perplexity-ai.png",
    type: "chat",
    version: "N/A",
    releaseDate: "2023",
    ...
    useCases: [
      {
        ...
        description:
          "Fetching up-to-date data from the web for accurate answers.",
      },
      {
        title: "Fact-checking",
        description:
          "Providing accurate and current data to confirm or refute claims.",
      },
      {
  ...
  },
  {
    ...
    provider: "Meta",
    description:
      "Llama 2 13B is a medium-sized version of Meta's Llama 2 model, designed for a wide range of natural language tasks.",
    image: "/models/meta.png",
    type: "chat",
    version: "2.0",
    releaseDate: "2023-07",
    ...
    useCases: [
      {
        ...
        description:
          "Generating text for a wide variety of applications such as articles, reports, and summaries.",
      },
      {
        title: "Programming Assistance",
        description:
          "Helping with code generation, debugging, and problem-solving.",
      },
      {
        title: "Question Answering",
        description:
          "Providing accurate answers based on available data and context.",
      },
    ],
    limitations: [
...

  {
    ...
    provider: "OpenAI",
    description:
      "Advanced image generation model capable of creating highly detailed and accurate images from text descriptions.",
  ...
  },
  {
    ...
    description:
      "Stable Diffusion is a text-to-image generation model that creates high-quality images based on textual descriptions.",
    ...
    useCases: [
      {
        ...
        description:
          "Create stunning artworks, illustrations, and design concepts.",
      },
      {
        title: "Concept Art",
  ...
  },
  {
    ...
    provider: "Stability AI",
    description:
      "Stable Diffusion XL is a powerful image generation model from Stability AI, designed for creating high-quality, detailed images from text prompts. It offers advanced capabilities for artistic, photorealistic, and creative visual content generation.",
    image: "/models/stability-ai.png",
    type: "image",
    version: "XL",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2024",
      architecture:
        "Transformer-based with advanced denoising and conditioning techniques",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Create stunning, high-resolution artwork from text descriptions, including diverse artistic styles such as impressionism, surrealism, and abstract art.",
      },
      {
        title: "Photorealistic Image Generation",
        description:
          "Generate lifelike, photorealistic images from prompts, useful for creating realistic environments, product designs, and digital media content.",
      },
      {
        title: "Image Inpainting and Editing",
        description:
          "Edit existing images by providing text instructions for modifying specific areas, including image restoration and creative content editing.",
      },
      {
        title: "Style Transfer and Image Translation",
        description:
          "Convert images into different styles or transfer one image's visual characteristics to another, enabling creative flexibility for designers and artists.",
      },
      {
        title: "Customizable Visual Content Generation",
        description:
          "Generate highly customizable images for commercial, creative, and marketing purposes with detailed control over visual elements, color palettes, and composition.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2024",
      architecture:
        "Advanced GANs (Generative Adversarial Networks) combined with Transformer-based models",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate unique, high-quality images for creative industries such as marketing, advertising, and social media, with flexibility in artistic style and composition.",
      },
      {
        title: "Concept Art and Visualization",
        description:
          "Create conceptual art, environment designs, and illustrations for games, movies, and entertainment projects, with a focus on detailed scene generation and visual storytelling.",
      },
      {
        title: "Product Visualization",
        description:
          "Generate photorealistic renderings of products for e-commerce, prototyping, or promotional materials, enabling quick and accurate visual representation of concepts.",
      },
      {
        title: "Image Super-Resolution",
        description:
          "Enhance the resolution and quality of low-resolution images, ideal for applications requiring detailed upscaling or image refinement.",
      },
      {
        title: "Image Editing and Inpainting",
        description:
          "Edit and refine existing images through image-to-image transformations, including inpainting, object removal, and scene adjustment.",
      },
    ],
    limitations: [
...

  {
    ...
    technicalSpecs: {
      ...
      architecture:
        "Transformer-based model trained on diverse multilingual datasets",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Provide live transcription services for meetings, lectures, webinars, and more, offering accurate text representation of spoken language.",
      },
      {
        title: "Multilingual Support",
        description:
          "Translate and transcribe speech from various languages to text, making it an ideal tool for global communication and content accessibility.",
      },
      {
        title: "Speech-to-Text for Accessibility",
        description:
          "Enhance accessibility by providing real-time captions and transcriptions for individuals with hearing impairments, enabling more inclusive experiences.",
      },
      {
        title: "Voice Commands and Control",
        description:
          "Integrate Whisper AI into voice-activated systems, enabling efficient voice control and interaction for applications ranging from smart homes to virtual assistants.",
      },
      {
        title: "Audio Search and Indexing",
        description:
          "Enable text search and indexing of large audio or video archives by transcribing speech and providing searchable text outputs.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Meta",
    description:
      "MusicGen AI is an advanced generative model by Meta designed to create high-quality music from text prompts. Capable of producing a variety of genres and styles, MusicGen allows for creative exploration in music composition. Its deep learning architecture allows users to input simple text descriptions and generate complex, multi-instrumental pieces of music.",
    image: "/models/meta.png",
    type: "audio",
    version: "1.0",
    releaseDate: "2023",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2023",
      architecture:
        "Transformer-based model trained on a diverse collection of musical datasets",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate original music tracks from scratch based on descriptive text prompts, providing an innovative tool for musicians and content creators.",
      },
      {
        title: "Film and Game Scoring",
        description:
          "Create soundtrack music for films, games, and media projects, allowing for flexible composition that fits specific themes, moods, or scenes.",
      },
      {
        title: "Jingles and Commercial Music",
        description:
          "Generate catchy, brand-appropriate music for advertising, commercials, and promotional content.",
      },
      {
        title: "Music for Video Content",
        description:
          "Generate background music for videos, YouTube channels, and social media content, ensuring a unique, royalty-free soundtrack.",
      },
      {
        title: "Music Remixing and Arrangement",
        description:
          "Modify existing compositions by rearranging elements, changing instruments, or adapting the style to suit different genres or preferences.",
      },
    ],
    limitations: [
...

  {
    ...
    provider: "Sora Labs",
    description:
      "Sora AI is an advanced generative model that creates highly realistic avatars and animated characters based on simple text descriptions. With a focus on animation, Sora can generate characters, facial expressions, and complex motions suitable for gaming, animation, and virtual reality environments.",
    image: "/models/gpt-4.png",
    type: "video",
    version: "1.0",
    releaseDate: "2023",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2023",
      architecture:
        "Transformer-based models for motion synthesis and avatar generation",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate realistic characters with diverse visual styles, suitable for integration into games, animated films, or virtual worlds.",
      },
      {
        title: "Virtual Reality Avatars",
        description:
          "Create personalized avatars for virtual reality platforms that adapt dynamically to user interactions and real-time scenarios.",
      },
      {
        title: "Motion Capture and Animation",
        description:
          "Generate lifelike animations for characters, reducing the need for manual animation by using text prompts for automated creation.",
      },
      {
        title: "Film and Animation Production",
        description:
          "Generate animated characters for films and animations, saving time in character design and animation processes.",
      },
      {
        title: "Interactive Virtual Assistants",
        description:
          "Generate real-time animated avatars for virtual assistants that can mimic human interactions in a more dynamic and engaging way.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Runway",
    description:
      "Runway Gen-2 is a powerful generative model designed to produce high-quality video content from text prompts. Combining advanced AI with video processing, it allows for seamless creation of videos, animations, and visual content in various styles, from photorealistic to abstract.",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2023",
      architecture:
        "Combination of generative adversarial networks (GANs) and diffusion models",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Create dynamic and engaging video content for social media platforms, from quick clips to high-quality productions.",
      },
      {
        title: "Advertising and Marketing",
        description:
          "Generate customized video ads and promotional material based on brand guidelines or creative briefs.",
      },
      {
        title: "Music Video Generation",
        description:
          "Generate music videos from song lyrics and prompts, producing visually striking and creative visual representations.",
      },
      {
        title: "Film and Animation Production",
        description:
          "Assist in the production of films and animations by automating video synthesis, reducing production times and costs.",
      },
      {
        title: "Interactive Video Experiences",
        description:
          "Create interactive and immersive video content for VR, AR, and web-based platforms.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Luma Labs",
    description:
      "Luma AI (Video) is a powerful generative model designed to create high-quality, photorealistic video content from text descriptions. This AI can synthesize entire video scenes, generate dynamic environments, animate objects, and control lighting in a fully generative manner, making it ideal for virtual production, cinematic content creation, and immersive media experiences.",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2023",
      architecture:
        "Generative networks combined with advanced video synthesis and dynamic scene rendering",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate high-quality video content for films, commercials, and music videos, including complex scenes with dynamic action and camera movements.",
      },
      {
        title: "Virtual Environments",
        description:
          "Create immersive virtual environments for VR, AR, and simulation applications, with full control over scene composition and dynamic elements.",
      },
      {
        title: "Game Development",
        description:
          "Automate video cutscenes, trailers, and in-game cinematics by generating realistic, high-quality video from game scripts or concepts.",
      },
      {
        title: "Advertising and Marketing",
        description:
          "Produce customized video ads, product videos, and promotional material with dynamic visual effects and seamless transitions.",
      },
      {
        title: "Interactive Media",
        description:
          "Enable real-time video generation for interactive media experiences like virtual events, live-streaming, and social media content.",
      },
    ],
    limitations: [
  ...
  },
  {
    ...
    provider: "Kling Labs",
    description:
      "Kling AI (Video) is an advanced generative video model designed to create contextually rich, high-quality video content from simple text prompts. With its ability to generate entire video sequences with dynamic environments, actions, and nuanced dialogue, it’s an ideal tool for content creators, filmmakers, and virtual assistants seeking immersive video production.",
    ...
    technicalSpecs: {
      ...
      trainingData: "Up to 2023",
      architecture:
        "Transformer-based models with video synthesis and advanced language-video generation techniques",
    },
    benchmarks: [
    ...
    useCases: [
      {
        ...
        description:
          "Generate video content directly from written scripts or text descriptions, ideal for filmmakers, advertisers, and digital content creators.",
      },
      {
        title: "Virtual Assistants",
        description:
          "Create interactive video responses for virtual assistants, integrating voice, actions, and real-time content generation.",
      },
      {
        title: "Educational Content",
        description:
          "Generate instructional videos, explainer videos, or interactive educational content tailored to specific learning objectives.",
      },
      {
        title: "Gaming and Entertainment",
        description:
          "Create in-game cinematics, trailers, and interactive storylines that adapt to user choices or random events.",
      },
      {
        title: "Creative Storytelling",
        description:
          "Generate narrative-driven content with complex character interactions, rich environments, and high-quality visuals.",
      },
    ],
    limitations: [
    ...
    useCases: [
      {
        ...
        description:
          "Create animations and motion sequences from single or multiple images, ideal for adding movement to still art, product images, or characters.",
      },
      {
        title: "Marketing Video Content",
        description:
          "Enhance marketing materials by turning static product images or promotional visuals into engaging animated videos.",
      },
      {
        title: "Interactive Media and Social Media Content",
        description:
          "Generate dynamic video content for social media platforms, including short animated ads, gifs, and creative clips.",
      },
      {
        title: "Game Asset Animation",
        description:
          "Animate game assets, objects, and characters from concept art or static 3D models to bring them to life in motion.",
      },
      {
        title: "Creative Video Effects",
        description:
          "Apply cinematic effects such as camera movements, slow motion, and lighting changes to enhance video production quality.",
      },
    ],
    limitations: [
